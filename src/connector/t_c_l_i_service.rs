      ...
      Err(
        thrift::Error::Protocol(
          ProtocolError::new(
            ...
            "received union with unknown variant from remote TTypeQualifierValue"
          )
        )
      )
      ...
      match field_id {
        1 => {
          ...
          for _ in 0..map_ident.size {
            ...
            match TTypeQualifierValue::read_from_in_protocol(i_prot) {
              Ok(value) => { val.insert(map_key_0, value); },
    ...
    if total_field_count == 0 {
      ...
      Err(
        thrift::Error::Protocol(
          ProtocolError::new(
            ProtocolErrorKind::UnknownUnionVariant,
            "received union with unknown variant from remote TTypeEntry"
          )
        )
      )
    } else if let Some(ret) = ret {
      ...
      match field_id {
        1 => {
          ...
          for _ in 0..list_ident.size {
            match TTypeEntry::read_from_in_protocol(i_prot) {
              Ok(elem) => { val.push(elem); },
              Err(thrift::Error::Protocol(ref e)) if e.kind == ProtocolErrorKind::UnknownUnionVariant => { continue; },
              Err(e) => return Err(e),
            }
          }
    ...
    if total_field_count == 0 {
      ...
      Err(
        thrift::Error::Protocol(
          ProtocolError::new(
            ProtocolErrorKind::UnknownUnionVariant,
            "received union with unknown variant from remote TColumnValue"
          )
        )
      )
    } else if let Some(ret) = ret {
    ...
    loop {
      ...
      match field_id {
        1 => {
          ...
          for _ in 0..list_ident.size {
            match TColumnValue::read_from_in_protocol(i_prot) {
              Ok(elem) => { val.push(elem); },
              Err(thrift::Error::Protocol(ref e)) if e.kind == ProtocolErrorKind::UnknownUnionVariant => { continue; },
              Err(e) => return Err(e),
            }
    ...
    if total_field_count == 0 {
      ...
      Err(
        thrift::Error::Protocol(
          ProtocolError::new(
            ProtocolErrorKind::UnknownUnionVariant,
            "received union with unknown variant from remote TColumn"
          )
        )
      )
    } else if let Some(ret) = ret {
    ...
    loop {
      ...
      match field_id {
        ...
        3 => {
          ...
          for _ in 0..list_ident.size {
            match TColumn::read_from_in_protocol(i_prot) {
              Ok(elem) => { val.push(elem); },
              Err(thrift::Error::Protocol(ref e)) if e.kind == ProtocolErrorKind::UnknownUnionVariant => { continue; },
              Err(e) => return Err(e),
            }
    ...
    if total_field_count == 0 {
      ...
      Err(
        thrift::Error::Protocol(
          ProtocolError::new(
            ProtocolErrorKind::UnknownUnionVariant,
            "received union with unknown variant from remote TGetInfoValue"
          )
        )
      )
    } else if let Some(ret) = ret {
...
impl TGetOperationStatusResp {
  pub fn new<F2, F3, F4, F5, F6, F7, F8, F9, F10>(status: TStatus, operation_state: F2, sql_state: F3, error_code: F4, error_message: F5, task_status: F6, operation_started: F7, operation_completed: F8, has_result_set: F9, progress_update_response: F10) -> TGetOperationStatusResp where F2: Into<Option<TOperationState>>, F3: Into<Option<String>>, F4: Into<Option<i32>>, F5: Into<Option<String>>, F6: Into<Option<String>>, F7: Into<Option<i64>>, F8: Into<Option<i64>>, F9: Into<Option<bool>>, F10: Into<Option<Box<TProgressUpdateResp>>> {
    TGetOperationStatusResp {
      status,
